namespace ProjetoFinal_InforQui.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ProjetoFinal_InforQui.Models.InforQuiDB>
    {
        ...
        protected override void Seed(ProjetoFinal_InforQui.Models.InforQuiDB context)
        {
            ...
            {
                new Utilizadores {UtilizadorID=1, Nome="Santos", Apelido="Pires", Email="santospires@hotmail.com",
                                 Morada ="Santarem", Contacto="965567323", Imagem="Santos_Pires.png"},
                new Utilizadores {UtilizadorID=2, Nome="Andre", Apelido="Quintão", Email="andrequintao99@yahoo.com",
                                 Morada ="Entroncamento", Contacto="925676332", Imagem="Andre_Quintao.jpg"},
                new Utilizadores {UtilizadorID=3, Nome="Manuel", Apelido="Pinto", Email="manuel1982@hotmail.com",
                                 Morada ="Tomar", Contacto="963387123", Imagem="Manuel_Pinto.png"},
                new Utilizadores {UtilizadorID=4, Nome="Mariano", Apelido="Freitas", Email="freitasmariano90@gmail.com",
                                 Morada ="Torres Novas", Contacto="966789552", Imagem="Mariano_Freitas.png"},
                new Utilizadores {UtilizadorID=5, Nome="Mario", Apelido="Suares", Email="suares1985@gmail.com",
                                 Morada ="Lisboa", Contacto="92776929", Imagem="Mario_Suares.jpeg"},
                new Utilizadores {UtilizadorID=6, Nome="Martinho", Apelido="Gusmão", Email="gusmao1979@hotmail.com",
                                 Morada ="Lisboa", Contacto="965556743", Imagem="Martinho_Gusmao.jpeg"},
                new Utilizadores {UtilizadorID=7, Nome="Rosito", Apelido="Belo", Email="rositobelo@yahoo.com",
                                 Morada ="Entroncamento", Contacto="936656992", Imagem="Rosito_Belo.png"},
            };
